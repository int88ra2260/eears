...
export default function EnglishTestDetailForm({ initialData, basicInfo, step3Data, onBack, onClose }) {
  ...
  const [formData, setFormData] = useState({
    ...
    // Q14-Q18: 特殊身分與協助需求（步驟四）
    isLowIncome: '',
    hasDisabilityCard: '',
    disabilityTypes: [],
    disabilityOther: '', // 身心障礙類別「其他」的文字輸入
    disabilityCertFront: null,
    disabilityCertBack: null,
    examAssistanceOptions: [],
    examAssistanceOther: '', // 考試協助項目「其他」的文字輸入
    
    // Q19-Q21: 照片與同意事項（步驟四）
    idPhoto: null,
    agreedToTerms: false,
    infoSource: '',
    infoSourceOther: '', // Q21 其他選項的文字輸入
    addressConfirmed: false // Q8 地址確認勾選項目
  });
  ...
  const handleChange = (e) => {
    ...
    if (type === 'checkbox') {
      if (name === 'agreedToTerms' || name === 'addressConfirmed') {
        ...
        // 處理複選框（如 passedExamTypes, disabilityTypes 等）
        setFormData(prev => {
  ...
  const validateForm = () => {
    ...
    if (!formData.addressConfirmed) {
      newErrors.addressConfirmed = '請確認地址資訊';
      errorOrder.push('addressConfirmed');
    }

    // Q9-Q13: 學籍資料必填（步驟四重新編號）
    ...
    if (formData.infoSource === '其他' && !formData.infoSourceOther.trim()) {
      newErrors.infoSourceOther = '請填寫其他資訊來源';
      if (!errorOrder.includes('infoSourceOther')) errorOrder.push('infoSourceOther');
    }
    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="mb-4">
        ...
        <div className="mb-3" ref={getFieldRef('studentNameZh')}>
          ...
          <input
            ...
            onChange={handleChange}
            style={getErrorStyle('studentNameZh')}
          />
        ...
        <div className="row mb-3">
          <div className="col-md-6" ref={getFieldRef('lastNameEn')}>
            ...
            <input
              ...
              onChange={handleChange}
              style={{ textTransform: 'uppercase', ...getErrorStyle('lastNameEn') }}
              placeholder="大寫英文姓氏"
            />
            {errors.lastNameEn && (
              <div className="text-danger mt-2 p-2 rounded" style={{ 
          ...
          <div className="col-md-6" ref={getFieldRef('firstNameEn')}>
            ...
            <input
              ...
              onChange={handleChange}
              style={{ textTransform: 'uppercase', ...getErrorStyle('firstNameEn') }}
              placeholder="大寫英文名字"
            />
            {errors.firstNameEn && (
              <div className="text-danger mt-2 p-2 rounded" style={{ 
      ...
      <div className="mb-4">
        ...
        <div className="mb-3" ref={getFieldRef('postalCode')}>
          <label className="form-label">
            Q8. 通訊地址 <span style={{ color: 'red' }}>*</span>
          </label>
          <div className="row">
        ...
        <div className="mb-3" ref={getFieldRef('addressConfirmed')}>
          <div style={errors.addressConfirmed ? { 
            padding: '1rem', 
            border: '3px solid #dc3545', 
            borderRadius: '5px',
            backgroundColor: '#fff5f5'
        ...
        <div className="row mb-3">
          <div className="col-md-6" ref={getFieldRef('degreeLevel')}>
            ...
            <select
              ...
              onChange={handleChange}
              style={getErrorStyle('degreeLevel')}
            >
          ...
          <div className="col-md-6" ref={getFieldRef('department')}>
            ...
            {formData.college && departmentOptions[formData.college] ? (
              <select
                ...
                onChange={handleChange}
                style={getErrorStyle('department')}
              >
                <option value="">請選擇</option>
        ...
        {formData.hasDisabilityCard === '是' && (
          <>
            <div className="mb-3">
              ...
              {formData.disabilityTypes.includes('其他') && (
                <div className="mt-3">
                  <input
                    type="text"
                    className="form-control"
              ...
              <div className="row">
                <div className="col-md-6 mb-2">
                  ...
                  {previewUrls.disabilityCertFront && (
                    <div className="mt-2">
                      <small className="text-muted d-block mb-1">預覽：</small>
                      <img
      ...
      <div className="mb-4">
        ...
        <div className="mb-3" ref={getFieldRef('idPhoto')}>
          ...
          <div className="mt-3 p-3 rounded" style={{ 
            ...
            <div className="mt-2 mb-2 p-2 rounded" style={{ 
              backgroundColor: '#fff4e6', 
              border: '2px solid #ff8c00',
              fontSize: '0.95rem',
              lineHeight: '1.6'
            }}>
              <strong style={{ color: '#cc6600' }}>本次考試可免費下載電子證書， 證書上將印出考生照片。由於報名完成後無法再抽換照片，請上傳符合證件規格、正面清晰、背景乾淨之照片，避免未來遺憾。</strong>
            </div>
              ...
              <div className="col-md-6 mb-3">
                <div className="p-3 rounded" style={{ 
                  ...
                  <img
                    ...
                    onClick={() => window.open('/正確證件照範例.png', '_blank')}
                    onError={(e) => {
              ...
              <div className="col-md-6 mb-3">
                <div className="p-3 rounded" style={{ 
                  ...
                  <img
                    ...
                    onClick={() => window.open('/不合格證件照範例.jpg', '_blank')}
                    onError={(e) => {
                      e.target.style.display = 'none';
                      e.target.nextSibling.style.display = 'block';
                    }}
        ...
        <div className="mb-4" ref={getFieldRef('agreedToTerms')}>
          ...
          {errors.agreedToTerms && (
            <div className="text-danger mt-2 p-2 rounded" style={{ backgroundColor: '#f8d7da', fontSize: '1rem', fontWeight: 'bold' }}>
              {errors.agreedToTerms}
            </div>
          )}
        </div>
          ...
          {formData.infoSource === '其他' && (
            <div className="mt-3" ref={getFieldRef('infoSourceOther')}>
              <input
                ...
                style={getErrorStyle('infoSourceOther')}
              />
